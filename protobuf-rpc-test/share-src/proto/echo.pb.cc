...
void protobuf_AddDesc_echo_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    "\n\necho.proto\022\014pb.echo.test\"\036\n\013EchoReques"
    "t\022\017\n\007message\030\001 \002(\t\"\037\n\014EchoResponse\022\017\n\007me"
    "ssage\030\001 \002(\t2K\n\nEchoServer\022=\n\004Echo\022\031.pb.e"
    "cho.test.EchoRequest\032\032.pb.echo.test.Echo"
    "ResponseB\003\200\001\001", 173);
...
EchoRequest::EchoRequest()
  ...
  SharedCtor();
  // @@protoc_insertion_point(constructor:pb.echo.test.EchoRequest)
}
...
EchoRequest::EchoRequest(const EchoRequest& from)
  ...
  SharedCtor();
  MergeFrom(from);
  // @@protoc_insertion_point(copy_constructor:pb.echo.test.EchoRequest)
}
...
EchoRequest::~EchoRequest() {
  // @@protoc_insertion_point(destructor:pb.echo.test.EchoRequest)
  SharedDtor();
}
...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:pb.echo.test.EchoRequest)
  for (;;) {
...
success:
  // @@protoc_insertion_point(parse_success:pb.echo.test.EchoRequest)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:pb.echo.test.EchoRequest)
  return false;
#undef DO_
}
...
void EchoRequest::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:pb.echo.test.EchoRequest)
  // required string message = 1;
  if (has_message()) {
    ::google::protobuf::internal::WireFormat::VerifyUTF8StringNamedField(
      this->message().data(), this->message().length(),
  ...
  // @@protoc_insertion_point(serialize_end:pb.echo.test.EchoRequest)
}

::google::protobuf::uint8* EchoRequest::SerializeWithCachedSizesToArray(
    ::google::protobuf::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:pb.echo.test.EchoRequest)
  // required string message = 1;
  if (has_message()) {
    ::google::protobuf::internal::WireFormat::VerifyUTF8StringNamedField(
      this->message().data(), this->message().length(),
  ...
  // @@protoc_insertion_point(serialize_to_array_end:pb.echo.test.EchoRequest)
  return target;
}
...
EchoResponse::EchoResponse()
  : ::google::protobuf::Message() {
  SharedCtor();
  // @@protoc_insertion_point(constructor:pb.echo.test.EchoResponse)
}
...
EchoResponse::EchoResponse(const EchoResponse& from)
  ...
  SharedCtor();
  MergeFrom(from);
  // @@protoc_insertion_point(copy_constructor:pb.echo.test.EchoResponse)
}
...
EchoResponse::~EchoResponse() {
  // @@protoc_insertion_point(destructor:pb.echo.test.EchoResponse)
  SharedDtor();
}
...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ::google::protobuf::uint32 tag;
  // @@protoc_insertion_point(parse_start:pb.echo.test.EchoResponse)
  for (;;) {
    ::std::pair< ::google::protobuf::uint32, bool> p = input->ReadTagWithCutoff(127);
    tag = p.first;
    if (!p.second) goto handle_unusual;
...
success:
  // @@protoc_insertion_point(parse_success:pb.echo.test.EchoResponse)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:pb.echo.test.EchoResponse)
  return false;
#undef DO_
}
...
void EchoResponse::SerializeWithCachedSizes(
    ::google::protobuf::io::CodedOutputStream* output) const {
  // @@protoc_insertion_point(serialize_start:pb.echo.test.EchoResponse)
  // required string message = 1;
  if (has_message()) {
    ::google::protobuf::internal::WireFormat::VerifyUTF8StringNamedField(
      this->message().data(), this->message().length(),
  ...
  // @@protoc_insertion_point(serialize_end:pb.echo.test.EchoResponse)
}

::google::protobuf::uint8* EchoResponse::SerializeWithCachedSizesToArray(
    ::google::protobuf::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:pb.echo.test.EchoResponse)
  // required string message = 1;
  if (has_message()) {
    ::google::protobuf::internal::WireFormat::VerifyUTF8StringNamedField(
      this->message().data(), this->message().length(),
  ...
  // @@protoc_insertion_point(serialize_to_array_end:pb.echo.test.EchoResponse)
  return target;
}
...
void EchoServer::Echo(::google::protobuf::RpcController* controller,
                         const ::pb::echo::test::EchoRequest*,
                         ::pb::echo::test::EchoResponse*,
...
void EchoServer::CallMethod(const ::google::protobuf::MethodDescriptor* method,
  ...
  switch(method->index()) {
    case 0:
      Echo(controller,
             ::google::protobuf::down_cast<const ::pb::echo::test::EchoRequest*>(request),
             ::google::protobuf::down_cast< ::pb::echo::test::EchoResponse*>(response),
             done);
      break;
    default:
...
const ::google::protobuf::Message& EchoServer::GetRequestPrototype(
  ...
  switch(method->index()) {
    case 0:
      return ::pb::echo::test::EchoRequest::default_instance();
    default:
      GOOGLE_LOG(FATAL) << "Bad method index; this should never happen.";
...
const ::google::protobuf::Message& EchoServer::GetResponsePrototype(
  ...
  switch(method->index()) {
    case 0:
      return ::pb::echo::test::EchoResponse::default_instance();
    default:
      GOOGLE_LOG(FATAL) << "Bad method index; this should never happen.";
      return *reinterpret_cast< ::google::protobuf::Message*>(NULL);
  }
...
void EchoServer_Stub::Echo(::google::protobuf::RpcController* controller,
                              const ::pb::echo::test::EchoRequest* request,
                              ::pb::echo::test::EchoResponse* response,
                              ::google::protobuf::Closure* done) {
